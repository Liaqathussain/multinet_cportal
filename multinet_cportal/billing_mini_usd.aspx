<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="billing_mini_usd.aspx.cs" Inherits="multinet_cportal.WebForm6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<link href="../../assets/global/css/billing-mini-usd.css" rel="stylesheet" type="text/css">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right right-section">
                                            ...
                                            <p class="circuit-number-title">Circuit Number: <span class="circuit-number">321-54367</span></p>
                        ...
                        <table class="table table-responsive">
                            <thead>
                                ...
                                <tr class="border-top">
                                    ...
                                    <th><h3 class="final-amount">15,000 $</h3></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
