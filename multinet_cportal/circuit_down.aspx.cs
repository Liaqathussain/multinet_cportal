    ...
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dtCircuitName = objMWS.GetCiruitsMainDetail(user, Convert.ToString(Session["BSSMasterCode"]), Convert.ToString("Please-Select"), Convert.ToString("Please-Select"), Convert.ToString("Please-Select"), Convert.ToString("Please-Select"), Convert.ToString("Please-Select"), Convert.ToString("0"), Convert.ToString("0"), Convert.ToString("1"), Convert.ToString("Please-Select"));
                ...
                else
                {
                    Tab_1.InnerHtml = "";
                    Tab_2.InnerHtml = "";
                    Tab_1.InnerHtml += "<div class='box-inside-tabs-active'><p class='pull-right'><img class='star' src='../../assets/global/img/empty-star.png'></p><p class='mobile'><a class='mobile' href=''></a></p><p class='branch'></p><p class='address'></p><p class='status'><span class='date'></span></p><p><a href='support-all-complain-details.html'><span class='small-icons'><p class='branch'>" + " Attention: " + "</p></span><p class='mobile'>" + " Records Not Found " + "</p></div>";
                    Tab_2.InnerHtml += "<div class='box-inside-tabs-active'><p class='pull-right'><img class='star' src='../../assets/global/img/empty-star.png'></p><p class='mobile'><a class='mobile' href=''></a></p><p class='branch'></p><p class='address'></p><p class='status'><span class='date'></span></p><p><a href='support-all-complain-details.html'><span class='small-icons'><p class='branch'>" + " Attention: " + "</p></span><p class='mobile'>" + " Records Not Found " + "</p></div>";
                }
            }
        }
        protected void RadCity_SelectedIndexChanged(object sender, EventArgs e)
        {
            DataTable dtCircuitName = objMWS.GetCiruitsMainDetail(user, Convert.ToString(Session["BSSMasterCode"]), RadCity.Text, RadInfra.Text, RadServiceUnit.Text, RadBandwidth.Text, RadRegion.Text, Convert.ToString(0), Convert.ToString(0), Convert.ToString(1), "Please-Select");
            if (dtCircuitName.Rows.Count > 0)
            {
                GetCircuitDetails(dtCircuitName);
            }
