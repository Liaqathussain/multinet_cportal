<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="billing_all_statements_inner.aspx.cs" Inherits="multinet_cportal.WebForm2" %>
<%@ Register assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" namespace="CrystalDecisions.Web" tagprefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<link href="../../assets/global/css/billing-all-statements-inner.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 header-box">
                        ...
                        <div class="col-md-12">
                            <div class="tab-pane fade active in" id="tab_2_1">
                                ...
                                <h1 class="main-title"><asp:Label ID="lblCustomerName" runat="server" Text="Label"></asp:Label></h1>
                                
<!--
                                <button type="submit" class="tab-buttons btn green-haze pull-right header-btns">
                                All Statements
                                </button>
                                
                                <button type="submit" class="active-tab btn tab-buttons green-haze pull-right header-btns">
                                Mini Statement
                                </button>
-->
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="tab-pane fade active in" id="Div1">
                                            ...
                                            <a href="#" class="labels-top pull-right" onclick="printPage('Default.aspx');"><img src="../../assets/global/img/print-icon.png" class="icons"> Print</a>
                                    ...
                                    <div class="row border-bottom">
                                        ...
                                        <div class="col-md-6 text-right right-section">
                                                <h3 class="heading-bold">Receipt Number: <asp:Label ID="lblInvoiceNo" runat="server" Text="Label"></asp:Label></h3>
                                                <p class="date">Due Date: <asp:Label ID="lblDate" runat="server" Text="Label"></asp:Label></p>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 border-between">
                                            ...
                                            <p class="address"><asp:Label ID="lblCustName" runat="server" Text="Label"></asp:Label></p>
                                            <p class="address"><asp:Label ID="lblCity" runat="server" Text="Label"></asp:Label></p>
                        ...
                        <table class="table table-responsive">
                            <thead>
                                ...
                                <tr class="border-top">
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><h3 class="final-amount"><asp:Label ID="lblTotalValue" runat="server" Text="Label"></asp:Label></h3></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
